...
export const weeklyReport0731: WeeklyReportPage = {
  ...
  keyMetrics: [
    ...
    { id: "dr007-r007", label: "DR007 / R007", valueText: "上行", changeText: "15bp / 13bp", interpretation: "短期流动性保持平稳", sourceText: "上周R007上行13bp，DR007上行15bp。" },
  ],
  heroCharts: ["passenger-vehicle-sales", "property-transactions-30-city", "brent-oil-price", "dr007-r007"],
  sections: [
    { id: "activity", title: "高频经济活动跟踪", summary: "上游重工业生产减速，但汽车生产和销售保持较快增长；一二线城市房地产和土地成交明显回升。", detail: "水泥开工率环比走高1个百分点，钢材成交量环比上行5.2%；30城商品房成交面积同比跌幅收窄至14.1%，土地成交同比上行45.9%。", charts: [
      ...
      chart("steel-cement", "activity", "钢材成交量与水泥企业开工率", "data-excel/国内周报Part1/【1,5,6,9,12,14】电厂&螺纹钢产量&水泥发运率（Wind+iFind）.xlsx", "水泥开工率"),
    ...
    { id: "financial", title: "利率、汇率及金融市场环境", summary: "短期流动性保持平稳，融资环境持续偏弱，人民币兑美元小幅上行。", detail: "R007和DR007分别上行13bp和15bp；国债收益率曲线略微陡峭下行，地产债、海外债与股票融资额走弱。", charts: [
      chart("dr007-r007", "financial", "上周DR007和R007分别上升", "data-excel/国内周报Part3/【49】DR007R007.xlsx", "DR007R007", true),
